    ...
    <div>
        ...
        <div class="w-full md:h-96 sm:h-80 h-74 shadow-2xl overflow-hidden relative">
            ...
            <div class="lg:flex md:flex flex justify-between relative ">
                <img src="img/logo-use.png" class=" lg:w-32 md:w-32 sm:w-24 w-20 lg:ml-10 md:ml-10 sm:ml-5 ml-1 " alt="">
                <ul class="flex mt-5 lg:space-x-8 md:space-x-4 sm:pace-x-4 space-x-2">
                    <li class="  text-white hover:text-green-400 duration-100"><a href="#"
            ...
            <div class="lg:mr-10 m-5 space-y-5 ">
                ...
                <ul class="space-y-5">
                    <li class="flex">
                        ...
                        <span class="mr-5 justify-start text-xs ">Brige2, National Road 6A, Sanngkat Prek Leap, Khan Chroy
                            Changva, Phnom
                            Penh</span>
                    </li>
                    <li class="flex">
                        ...
                        <span class="text-xs">097 685 423</span>
                    </li>
                    <li class="flex">
                        ...
                        <span class="text-xs">preteke.content@gmail.com</span>
                    </li>
                </ul>
            </div>
        </div>
