...
<body class="font-poppins">
    <main>
      ...
      <svg class=" moon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"></path>
                ...
                <div>
                    ...
                    <div class=" flex flex-row-reverse">
                        <!-- Edit account -->
                        <div>
                            <button class=" rounded-md outline outline-green-500 lg:w-36 lg:h-9 w-24 h-7 m-1 text-xs lg:text-sm"> Edit profile </button>
                        </div>

                        <!-- Upload the new event -->
                        <div>
                            <button class=" rounded-md outline outline-green-500 bg-green-500 lg:w-36 lg:h-9 w-24 h-7 m-1 hover:bg-green-700 text-xs lg:text-sm"> Upload new event</button>
                        </div>
                    ...
                    <div class=" lg:w-1/3 m-3">
                        ...
                        <div class=" border border-green-500">
                            ...
                            <div class=" flex m-3">
                                ...
                                <p class=" pl-3 text-sm lg:text-base">Studies Computer Science at Cambodia Academy of Digital Technology -
                                    CADT</p>
                    ...
                    <div class=" lg:w-2/3 border border-green-500 m-3">
                        ...
                        <div class=" m-4 p-3 border border-gray-500 shadow-slate-400 ">
                            ...
                            <div class="flex flex-row space-x-4">
                                ...
                                <!-- event post info -->
                                <div class=" basis-1/2">
                                    <p class=" font-bold text-xs md:text-sm lg:text-base">Explore, learn how to start technology company</p>
                                    <div class=" flex space-x-1">
                                        <svg class="w-8 lg:w-8 lg:m-3 md:m-3 m-1" fill="none" stroke="currentColor" stroke-width="1.5"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5">
                                            </path>
                                        </svg>
                                        <p class=" font-sans text-xs mt-2 md:mt-5 lg:mt-5"> :Sun, Apr 9, 2023 10:00 PM +07 + 1 more event
                                        </p>
                                    </div>
                                    ...
                                    <div class=" flex">
                                        ...
                                        <p class=" font-sans text-xs mt-2 md:mt-5 lg:mt-5">: online</p>
                                    </div>

                                    <div class=" flex">
                                        <svg class=" w-6 lg:w-8" fill="none" stroke="currentColor" stroke-width="1.5"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z">
                                            </path>
                                        </svg>
                                        <p class=" font-sans text-xs mt-2 md:mt-5 lg:mt-5"> 100 seats</p>
                                    </div>

                                    <div class=" flex">
                                        <p class=" font-semibold text-xs md:text-sm lg:text-base">Agenda </p>
                                        <a href="#" class=" hover:text-green-500 text-xs md:text-sm lg:text-base">: www.djfskaljfk.pdf</a>

                                    </div>

                                    <div class=" flex mt-1.5 mb-1.5 ">
                                        <p class=" font-semibold text-xs md:text-sm lg:text-base ">Price </p>
                                        <p class=" font-bold text-red-600 text-xs md:text-sm lg:text-base">: $0.00</p>
                                        
                                    </div>
                                    <div class=" pl-10 mb-3">
                            <button class=" text-center align-middle outline outline-green-500 bg-green-500 w-20 h-5 hover:bg-green-700 text-xs lg:text-sm">Register</button>
                        </div>

                                    <div class=" flex">
                                        <p class=" font-light text-sm ">Rate  </p>

                                        <svg class=" lg:w-5 w-4" fill="none" stroke="currentColor" stroke-width="1.5"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <div class=" flex justify-items-end">
                                            <button>
                                                <svg class=" lg:w-5 w-4 hover:fill-green-500" fill="none" stroke="currentColor"
                        ...
                        <div class=" m-4 p-3 border border-gray-500 shadow-slate-400 ">
                            ...
                            <div class="flex flex-row space-x-4">
                                ...
                                <!-- event post info -->
                                <div class=" basis-1/2">
                                    <p class=" font-semibold text-sm lg:text-base">Explore, learn how to start technology company</p>
                                    <div class=" flex">
                                        <svg class=" w-8" fill="none" stroke="currentColor" stroke-width="1.5"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class=" flex">
                                        ...
                                        <a href="#" class=" hover:text-green-500 text-sm lg:text-base">www.djfskaljfk.pdf</a>
